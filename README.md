...
This is the current status of the resources that have been implemented by the repository. 

|resource | status | folder |
|---|---|---|
...
|azurerm_automation_dsc_configuration | ✔ | Management |
|azurerm_automation_dsc_nodeconfiguration | ❌ | |
|azurerm_automation_hybrid_runbook_worker_group | ❌ | |
|azurerm_automation_job_schedule | ❌ | |
|azurerm_automation_module | ❌ | |
|azurerm_automation_runbook | ❌ | |
|azurerm_automation_schedule | ✔ | Management |
